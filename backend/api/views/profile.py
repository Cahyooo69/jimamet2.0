...
def update_profile(request):
    ...
    try:
        ...
        if "full_name" in update_data:
            mapped_data["nama"] = update_data["full_name"]
        if "age" in update_data:
            mapped_data["umur"] = update_data["age"]
        if "weight" in update_data:
            mapped_data["berat_badan"] = update_data["weight"]
        if "height" in update_data:
            mapped_data["tinggi_badan"] = update_data["height"]
        if "activity_level" in update_data:
            mapped_data["aktivitas_harian"] = update_data["activity_level"]
        ...
        if rows:
            ...
            if "nama" not in mapped_data:
                mapped_data["nama"] = request.user.get_full_name()
